    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
      ...
      <div className="space-y-10">
        ...
        <div className="border border-slate-200 rounded-[2rem] bg-white h-80 flex items-center justify-center relative shadow-sm p-6 overflow-hidden">
          {/* Main Carlos desk */}
          <button
            onClick={() => onSelectPuesto("p-of-carlos", "Puesto Oficina Carlos (Of. 2)")}
          ...
          >
            <span className="text-[10px] uppercase tracking-wider font-extrabold text-slate-400">Puesto Principal</span>
            <span className="text-xs font-bold text-slate-700 mt-0.5">Oficina 2</span>
          ...
          <div className="absolute top-4 right-4">
            <button
              onClick={() => onSelectPuesto("p-it", "Puesto IT (Ofic. Carlos)")}
            ...
            >
              <span className="text-[9.5px] font-black tracking-wider text-red-700 bg-red-50 border border-red-100 px-1.5 py-0.5 rounded leading-none mb-1">
                IT
              </span>
              {isFilled("p-it") ? (() => {
          ...
          <div className="absolute bottom-4 left-4 text-[10px] font-bold text-slate-400 tracking-[0.25em] uppercase pointer-events-none font-mono">
            Oficina Carlos
          </div>
        </div>

        {/* Fila Puestos 17, 18, 19 */}
        <div className="grid grid-cols-3 gap-6">
          {["p-17", "p-18", "p-19"].map((id) => {
            ...
            return (
              <button
                key={id}
                onClick={() => onSelectPuesto(id, `Puesto ${num}`)}
                onMouseEnter={(e) => onMouseEnterPuesto(e, id)}
                onMouseLeave={onMouseLeavePuesto}
                style={getPuestoStyle(id)}
                className="min-h-[6.5rem] h-auto p-3 bg-white border border-slate-200 text-slate-500 hover:text-slate-800 rounded-2xl flex flex-col items-center justify-center cursor-pointer transition-all duration-205 hover:-translate-y-0.5 hover:bg-slate-50 hover:border-slate-300 relative font-mono shadow-sm"
              >
        ...
        <div className="border border-slate-200 rounded-[2rem] bg-white h-44 flex items-center px-6 md:px-12 relative shadow-sm justify-center">
          <button
            onClick={() => onSelectPuesto("p-juntas", "Sala de Juntas")}
          ...
          >
            <span className="text-xs font-black uppercase tracking-wider text-slate-600">Sala de Juntas</span>
            {isFilled("p-juntas") && (() => {
          ...
          <div className="absolute bottom-4 left-0 right-0 text-center text-[10px] font-bold text-slate-400 tracking-[0.25em] uppercase pointer-events-none font-mono">
            Sala de Juntas
          </div>
        </div>
        ...
        <div className="border border-slate-200 rounded-[2rem] bg-white h-44 flex items-center px-6 md:px-12 relative shadow-sm justify-center">
          <button
            onClick={() => onSelectPuesto("p-gerencia", "Oficina Gerencia")}
          ...
          >
            <span className="text-xs font-black uppercase tracking-wider text-purple-700">Gerencia</span>
            {isFilled("p-gerencia") && (() => {
      ...
      {/* COLUMNA DERECHA: MESAS COMUNES A, B, C */}
      <div className="space-y-10">
        
        {/* Mesa A */}
        <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-200 shadow-sm relative">
          <span className="absolute top-4 left-8 text-[9px] font-black text-red-700 uppercase tracking-widest bg-red-50 px-2.5 py-1 rounded-md border border-red-100 font-mono">
            Mesa A
          </span>
